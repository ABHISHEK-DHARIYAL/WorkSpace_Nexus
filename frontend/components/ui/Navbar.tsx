          ...
          <div className="flex justify-between h-14 sm:h-16 items-center">
            ...
            <div className="flex items-center space-x-1 sm:space-x-3 md:space-x-4">
              ...
              {user ? (
                ...
                <>
                  <button onClick={openLogin} className="text-sm font-bold text-[#5b4636] dark:text-[#eee1ba] hover:text-black dark:hover:text-white transition-colors">Login</button>
                  <button
                    onClick={openSignup}
